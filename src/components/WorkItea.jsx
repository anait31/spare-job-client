...
import image from '../assets/images/slide2.webp'
import image1 from '../assets/images/slide1.webp'
import image2 from '../assets/images/slide3.webp'
import image3 from '../assets/images/slide4.webp'
            ...
            <div className="grid grid-cols-4 gap-8">
                ...
                <Link to={'/jobs'}>
                    <div className="overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                        ...
                        <img className="object-cover w-full h-48 mt-2" src={image1} alt="NIKE AIR" />
                        <div className="flex items-center justify-between px-4 py-2 bg-gray-900">
                            <button className="px-2 py-1 text-xs font-semibold text-gray-900 uppercase transition-colors duration-300 transform bg-white rounded hover:bg-gray-200 focus:bg-gray-400 focus:outline-none">View All</button>
                        </div>
                    </div>
                ...
                <Link to={'/jobs'}>
                    <div className="overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                        ...
                        <img className="object-cover w-full h-48 mt-2" src={image2} alt="NIKE AIR" />
                        <div className="flex items-center justify-between px-4 py-2 bg-gray-900">
                            <button className="px-2 py-1 text-xs font-semibold text-gray-900 uppercase transition-colors duration-300 transform bg-white rounded hover:bg-gray-200 focus:bg-gray-400 focus:outline-none">View All</button>
                        </div>
                    </div>
                ...
                <Link to={'/jobs'}>
                    <div className="overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                        ...
                        <img className="object-cover w-full h-48 mt-2" src={image3} alt="NIKE AIR" />
                        <div className="flex items-center justify-between px-4 py-2 bg-gray-900">
                            <button className="px-2 py-1 text-xs font-semibold text-gray-900 uppercase transition-colors duration-300 transform bg-white rounded hover:bg-gray-200 focus:bg-gray-400 focus:outline-none">View All</button>
                        </div>
                    </div>
