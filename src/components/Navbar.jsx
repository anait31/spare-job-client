    ...
    <div className="navbar bg-base-100 shadow-sm px-14 ">
        <div className="flex-1">
          <Link to="/" className="flex gap-2 items-center">
            ...
            <span className="font-bold uppercase">Micro Job Website</span>
          </Link>
        </div>
        <div className="flex-none">
          <ul className="menu menu-horizontal px-1 uppercase font-bold space-x-3">
            <li>
              <Link to="/">Home</Link>
            </li>
            <li>
          ...
          {user && (
            <div className="dropdown dropdown-end">
              ...
              >
                ...
                <li className="mt-2">
                  <button onClick={logOut} className="bg-gray-200 uppercase block text-center">
                    Logout
                  </button>
                </li>
              </ul>
